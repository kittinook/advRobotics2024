...
import numpy as np
# Import custom SetGoal and RandGoal services
from adv_interface.srv import SetGoal, RandGoal
...
class DummyNode(Node):
    def __init__(self):
        ...
        # Create services to handle goal setting and random goal requests
