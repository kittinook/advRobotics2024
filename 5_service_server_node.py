...
import numpy as np
# Import the custom SetGoal service
from adv_interface.srv import SetGoal
...
class DummyNode(Node):
    def __init__(self):
        ...
        # Create a service to handle goal setting requests
        ...
        # Create a client to call the '/turtle1/eat' service
    ...
    def timmer_loop(self):
        if self.is_start:
            ...
            # If the distance to the target is greater than 0.1, set linear velocity
